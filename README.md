...
* **manidocMCP**: 外部のAIデスクトップ等から、ローカルに蓄積された安全なデータにアクセスするための **MCP（Model Context Protocol）サーバー**。AIに「社内データの〇〇について教えて」と問いかけて答えさせるといった、セキュアなローカルRAG（検索拡張生成）を実現します。また、AIにデータを直接操作させてナレッジを自律構築することも可能です。
